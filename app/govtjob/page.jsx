...
const GovtJobPage = () => {
  return (
   ...
   <div className='  ml-10 py-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  place-items-center gap-10  '>
  
    {
      govtJobCircular.map((item) => (
        <div key={item.id}
         className=' border border-green-400 p-3 shadow-md hover:shadow-2xl shadow-slate-500 rounded-sm  group min-w-[250px] max-w-[250] '
        >
